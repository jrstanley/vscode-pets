...
const _vscode = __webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vscode'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
console.log('here');
    ...
    nextFrame() {
        ...
        if (this.hasFriend() &&
            ...
            if (this.friend().isPlaying() &&
                ...
                this.currentState = (0, states_1.resolveState)("chase-friend" /* chaseFriend */, this);
                this.currentStateEnum = "chase-friend" /* chaseFriend */;
                return;
            }
        }
